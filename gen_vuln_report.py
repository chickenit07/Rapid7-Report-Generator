...
def main():
    parser = argparse.ArgumentParser(description="Generate a report based on CSV and XML files.")
    ...
    output_file = os.path.join(os.getcwd(), f"{base_name}_Vuln_Details.xlsx")
    
    logging.info('Starting script...')
    generate_report(args.csv_file, args.xml_file, output_file)
